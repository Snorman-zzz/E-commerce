    ...
    return (
        <div className="app">
            ...
            <div className='main-content'>
                <div className='main-content'>
                    <h1 className='bag-love-heading'>Give your bag some love!</h1>
                </div>
                <Link to='/'>
                <button className='love-button'>SHOP WHAT'S NEW</button>
                </Link>
            </div>
            <div className="footer">
                <div className="footer-top">
                    <a href="https://info.lululemon.com/contact" className="footer-link" target="_blank" rel="noopener noreferrer">
                        Contact Us
                    </a>
                ...
                <div className="footer-bottom">
                    ...
                    <div className="legal-links">
                        <a href="https://info.lululemon.com/help/shipping" target="_blank" rel="noopener noreferrer">Shipping Policy</a>
                        <a href="https://info.lululemon.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy (Last Updated: 1/23/23)</a>
                        <a href="https://info.lululemon.com/legal/terms-of-use" target="_blank" rel="noopener noreferrer">Terms of Use (Last Updated: 10/5/22)</a>
                        <a href="https://info.lululemon.com/legal/privacy-policy#CCPA" target="_blank" rel="noopener noreferrer">California Privacy Rights (Last Updated: 1/23/23)</a>
                        <a href="https://info.lululemon.com/about/modern-slavery-statement" target="_blank" rel="noopener noreferrer">California Transparency Act</a>
                        <a href="https://info.lululemon.com/about/accessibility-statement" target="_blank" rel="noopener noreferrer">Accessibility Statement</a>
                    </div>
                </div>
            </div>
        </div>
